...
def process_caselaw_data():
    ...
    Now captures ALL citation components including decision number and member information.
    """
        ...
        for source_info in config['tables']['tables_to_read']:
            ...
            for index, row in records_to_process_df.iterrows():
                ...
                try:
                    ...
                    # Build the record with ALL citation components
                    record_data = {
                        'source_id': source_id,
                    ...
                    # Check mandatory fields (updated list)
                    mandatory_fields = ['neutral_citation', 'jurisdiction_code', 'tribunal_code', 'year', 'decision_number', 'decision_date', 'book_name']
                    ...
                    if failure_reasons:
                        ...
                        logging.info(f"{log_prefix}: All validations passed. Decision #{citation_details['decision_number']}")
                    ...
                    with dest_engine.connect() as conn:
                        if record_exists:
                            ...
                            update_data = {k: v for k, v in record_data.items() if v is not None}
