...
class VectorIngestor:
    ...
    def __init__(self, db_engine, doc_type: str):
        ...
        Args:
            ...
            doc_type (str): The type of document being processed (e.g., 'caselaw', 'legislation').
        """
            ...
            try:
                ...
                yield {
                    ...
                    "_source": {
                        ...
                        f"{self.doc_type}_embedding": embedding
                    }
                }
    ...
    def run_pipeline(self, pending_documents):
        ...
        try:
            success_count, failed_items = bulk(
                self.os_client,
                self._generate_bulk_actions(pending_documents),
                chunk_size=500,
